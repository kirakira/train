...
inline Pnt3f Pnt3f::operator - () const {
	return Pnt3f(-x, -y, -z);
};
// cross product
inline Pnt3f Pnt3f::operator*(const Pnt3f& p) const {
...
inline double dot(const Pnt3f &a, const Pnt3f &b) {
	return a.x * b.x + a.y * b.y + a.z * b.z;
}

inline double angle(const Pnt3f& a, const Pnt3f &b) {
	return acos(dot(a, b) / a.norm() / b.norm()) / acos(-1) * 180;
}
